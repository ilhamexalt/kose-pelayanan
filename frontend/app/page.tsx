    ...
    <div className="min-h-screen lg:h-screen flex flex-col relative bg-slate-50 dark:bg-[#090d16] transition-colors duration-300 overflow-x-hidden lg:overflow-hidden">
      ...
      <header className="relative z-20 w-full px-4 py-4 sm:px-6 sm:py-4 flex justify-between items-center max-w-screen-2xl mx-auto flex-shrink-0">
        ...
        <div className="flex items-center gap-3 bg-white/50 dark:bg-slate-800/50 backdrop-blur-md px-3 py-1.5 rounded-xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
          <ThemeToggle />
          <div className="w-px h-5 bg-slate-300 dark:bg-slate-600 hidden sm:block"></div>
          <Link 
            href="/login" 
            className="hidden sm:flex items-center justify-center px-4 py-1.5 rounded-lg bg-gradient-to-r from-[#DA251C] to-[#b01c14] hover:from-[#b01c14] hover:to-[#8c1610] text-white text-sm font-medium transition-all shadow-sm hover:shadow transform hover:-translate-y-0.5"
          >
            Masuk Portal
          </Link>
        </div>
      ...
      <main className="flex-1 min-h-0 flex flex-col lg:flex-row items-center justify-center px-4 sm:px-8 py-6 lg:py-2 relative z-10 max-w-screen-2xl mx-auto w-full gap-8 lg:gap-10">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-slate-900 dark:text-white mb-3 sm:mb-4 tracking-tight leading-tight">
            One Portal OJK <br className="hidden lg:block"/>
        ...
        <div className="flex-1 flex justify-center items-center w-full relative group mt-8 lg:mt-0 min-h-0">
          <div className="relative inline-block w-full max-w-[320px] sm:max-w-[380px] lg:max-w-none lg:w-auto">
            ...
            <div className="relative bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl border border-white/40 dark:border-slate-700/50 p-2 sm:p-3 rounded-3xl shadow-2xl transition-transform duration-700 group-hover:-translate-y-2 z-10 w-full lg:w-auto">
              ...
              {/* Floating Info Cards */}
              <div className="absolute -left-2 sm:-left-6 top-1/4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-2 sm:p-3 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 items-center gap-2 sm:gap-3 animate-bounce z-20 flex md:hidden lg:flex" style={{ animationDuration: '4s' }}>
              ...
              <div className="absolute -right-2 sm:-right-5 bottom-1/4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-2 sm:p-3 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 flex items-center gap-2 sm:gap-3 animate-bounce z-20" style={{ animationDuration: '3.5s', animationDelay: '1s' }}>
