    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-800 mb-1">Riwayat Pelayanan Selesai</h1>
            <p className="text-sm text-slate-500">Lihat data antrean yang sudah selesai atau batal diproses.</p>
          </div>
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-16 text-center">
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-base font-medium text-slate-600">Tidak ada riwayat pelayanan</p>
                        <p className="text-sm text-slate-400 mt-1">Data pelayanan yang telah selesai atau batal akan tampil di sini.</p>
                      </div>
                    </td>
                  </tr>
                )}
