                ...
                {selectedDetail.status === 'Selesai' ? (
                  <>
                    ...
                    {selectedDetail.catatan && (
                      <div className="mb-4 bg-slate-50 dark:bg-slate-800/40 p-3 rounded-xl border border-slate-200 dark:border-slate-700">
                        <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Catatan Pelayanan</p>
                        <p className="font-medium text-slate-900 dark:text-slate-100 text-sm whitespace-pre-wrap">{selectedDetail.catatan}</p>
                      </div>
                    )}
                  </>
                ) : (isAdmin || update) ? (
